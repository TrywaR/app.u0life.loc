...
function liveliner_day ( sForm, iDay, iMonth, iYear ) {
  ...
  $.when(
        ...
        if ( iCategoryMoneysSum || dateCategoryTimesSum  ) {
          ...
          sResultHtml += '<div class="_category" style="height:' + iCategoryHeightPercent + '%">'
            ...
            sResultHtml += '<div class="_buttons">'
              sResultHtml += '<a href="javascript:;" class="_button __time content_loader_show" data-action="times" data-animate_class="animate__flipInY" data-elem=".time" data-form="form" data-full="true" data-category_id="' + iCategoryId + '" data-date="' + iYear + '-' + iMonth + '-' + iDay + '" data-filter="true" data-success_click="#liveliner_reload_day">'
                sResultHtml += '<span class="_icon"><i class="fa-solid fa-clock"></i></span>'
              sResultHtml += '</a>'
              sResultHtml += '<a href="javascript:;" class="_button __money content_loader_show" data-action="moneys" data-animate_class="animate__flipInY" data-elem=".time" data-form="form" data-full="true" data-category="' + iCategoryId + '" data-date="' + iYear + '-' + iMonth + '-' + iDay + '" data-filter="true" data-success_click="#liveliner_reload_day">'
    ...
    sResultHtml += '<div class="_buttons">'
      sResultHtml += '<div class="_group __times">'
        ...
        sResultHtml += '</a>'
      sResultHtml += '</div>'
      sResultHtml += '<div class="_group __moneys">'
        sResultHtml += '<div class="_icon">'
